...
product_form.addEventListener('submit', function (e) {
    ...
    quantityElement = document.getElementById('product-quantity')

    quantity = quantityElement.value
    id = quantityElement.dataset.productId
    context={
        'product_quantity':quantity,
        'product_id':id,
    }
    
    post(add_to_cart_url,context)

    console.log(quantity, id)
})

function formCartItem(quantity, id) {
    return quantity, id
}
